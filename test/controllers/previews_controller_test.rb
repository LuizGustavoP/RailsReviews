...
class PreviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preview" do
    assert_difference('Preview.count') do
      post previews_url, params: { preview: { review: @preview.review, score: @preview.score, titulo: @preview.titulo } }
    end
  ...
  test "should update preview" do
    patch preview_url(@preview), params: { preview: { review: @preview.review, score: @preview.score, titulo: @preview.titulo } }
